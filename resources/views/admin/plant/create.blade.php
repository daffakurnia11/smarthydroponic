...
@section('container')
  ...
  <h6 class="mb-0 text-uppercase">Add a new Hydroponic Plant Types</h6>
  <hr>
  <div class="card">
    <form action="/admin/plant" method="post" enctype="multipart/form-data">
      @csrf
      <div class="card-body">
        <div class="row">
          <div class="col-lg-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Masukkan jenis tanaman" value="{{ old('name') }}">
              @error('name')
          ...
          <div class="col-lg-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('nursery_time') is-invalid @enderror" id="nursery_time" name="nursery_time" placeholder="Masukkan lama di persemaian" value="{{ old('nursery_time') }}">
              @error('nursery_time')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
          ...
          <div class="col-lg-4">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('leaves') is-invalid @enderror" id="leaves" name="leaves" placeholder="Masukkan jumlah helai daun" value="{{ old('leaves') }}">
              @error('leaves')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
          ...
          <div class="col-lg-4">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('planing_time') is-invalid @enderror" id="planing_time" name="planing_time" placeholder="Masukkan masa tanam" value="{{ old('planing_time') }}">
              @error('planing_time')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
